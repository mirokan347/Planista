...
class Table(View):
    def __init__(self, parent):
        ...
        self.notebookframe = ttk.Frame(self, width=1100, height=850, borderwidth=5, relief='flat')
        self.notebookframe.grid(row=0,column=0)
        
        
        # tworzenia ramki górnej w ramce głównej
        self.topframe = ttk.Frame(self.notebookframe, width=1100, height=200, borderwidth=5, relief='flat')
        ...
        self.middleframe = ttk.Frame(self.notebookframe, width=1100, height=450, borderwidth=5, relief='flat')
        self.middleframe.grid(row=1,column=0)        

        
        # tworzenia dolnej górnej w ramce głównej        
        self.bottomframe = ttk.Frame(self.notebookframe, width=1100, height=200, borderwidth=5, relief='flat')
